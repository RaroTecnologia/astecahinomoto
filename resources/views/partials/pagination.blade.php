                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-vermelho-asteca border border-vermelho-asteca cursor-default">{{ $page }}</span>
                                    </span>
                                @else
